...
export async function seedDatabase() {
  ...
  await db.insert(committeeNotes).values([
    ...
    },
    {
      ...
      content: "Active mandate maintains a +450 bps tactical tilt in HDFC Bank (34.0% vs benchmark weight of 29.5% in Nifty Bank). Annualized 3-Year Active Alpha stands at +2.84% gross and +2.18% net of transaction costs (25 bps round-trip friction, 14.2% portfolio turnover). Information Ratio is 0.56 (2.18% net alpha divided by 3.92% tracking error). Rebalancing rule enforced at 2.5% absolute drift.",
      recommendation: "OVERWEIGHT",
      targetAllocationPct: 34.0,
      status: "approved",
